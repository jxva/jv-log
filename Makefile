...
CFLAGS=-Wall -g -DDEBUG -pedantic -pipe -W -Werror=variadic-macros -Wpointer-arith -Wno-unused-parameter -Wunused-function -Wunused-variable -Wunused-value -Werror
